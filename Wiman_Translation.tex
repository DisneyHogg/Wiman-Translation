...
\end{enumerate}
The points of $x=0$ remain fixed here. If $f_6$ is also the JAKOBI covariant of $f_4$, the transformation group consists of 4 such $G_3$ and a Klein four-group of the kind \ref{item: 9.4}, which together form a
\begin{enumerate}[label=\arabic*)]
    \setcounter{enumi}{9}
