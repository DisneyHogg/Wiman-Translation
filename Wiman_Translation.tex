...
\end{equation}
to determine the ratios $ x_1: x_2 $ and $ y_1: y_2 $. From the point $ x = y = z = 0 $ or $ x_1 = y_1 = 0 $ you can now project the area and thus the curve onto the plane $ w = 0 $, whereby the image curve must satisfy the equation $F(y, x, y, z) = 0$.\footnote{See for example SALMON-FIELDER o.a. A. S. 521 or CLEBSCH-LINDEMANN, Vorlesungen \"uber Geometrie II 1, S. 422.} \\
